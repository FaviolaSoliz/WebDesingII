...
// var seccion=document.getElementByClassName('contenedor');
 //cajas=document.getElementsByTagName('div');
//cajas[0].textContent='Cambiando Contenido';

//cajas[1].innerHTML='<u> Caja2 </u>';
// var caja=document.getElemnetByClassName('caja');
 //var id_caja=document.getElemnetByIdName('primera');
